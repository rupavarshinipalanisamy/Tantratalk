...
const RemediesAll = ({ navigation }) => {
    const { t } = useTranslation();

    const renderItem = ({ item }) => {
        return (
            <View style={styles.itemContainer}>
                <TouchableOpacity style={styles.card} onPress={() => navigation.navigate(ScreenName.remediesdescription)} >
