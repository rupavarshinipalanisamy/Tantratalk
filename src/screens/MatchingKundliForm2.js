...
const MatchingKundliForm2 = ({ navigation }) => {
    const [selectedDate, setSelectedDate] = useState(null);
    const handleSubmit = () => {
        navigation.navigate(ScreenName.CompatabilityScore)
    };
    return (
                ...
                <View style={styles.centeredContent}>
                    <View style={styles.card}>
                        <View style={{ marginTop: 30 }}>
                            <Text style={{ color: colors.red, fontSize: 16, fontWeight: "bold", marginBottom: 10 }}>Enter Girl's Birth details</Text>
...
export default MatchingKundliForm2;
